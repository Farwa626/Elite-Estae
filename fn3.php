...
<body>
  ...
  <div class="gallery-container">
    <img src="images/Screenshot 2025-05-21 141726.png" class="main-image" id="mainImage" alt="Main Property Image">
    <div class="thumbnail-gallery" id="thumbnailGallery">
    
      <img src="images/Screenshot 2025-05-21 1432.png" onclick="changeMainImage(this.src)">
  ...
  <div class="property-info">
   <h2><i class="fas fa-user"></i><span>Muhammad Ali</span></h2>
    ...
    <div class="details-grid">
      ...
      <div><strong>Size:</strong> 2,500 sq ft</div>
      <div><strong>Price:</strong>87,000,000</div>
...
<script>
  ...
  const property = {
    ...
    image: "images/Screenshot 2025-05-21 141726.png",
